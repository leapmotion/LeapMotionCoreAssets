...
public class HandControllerEditor : Editor {
  ...
  public void OnSceneGUI() {
    ...
    Handles.DrawWireArc(origin, top_normal, local_top_left,
    ...
    Handles.DrawWireArc(origin, left_normal, local_bottom_left,
    ...
    Handles.DrawWireArc(origin, bottom_normal, local_bottom_left,
    ...
    Handles.DrawWireArc(origin, right_normal, local_bottom_right,
    ...
    Handles.DrawWireArc(origin, across_normal, local_left_face,
    ...
    Handles.DrawWireArc(origin, depth_normal, local_top_face,
